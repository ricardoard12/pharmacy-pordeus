		...
		<div id="content">
			...
			<div id="content_right">
				<h:form>
					...
					<fieldset>
						<legend style="margin-left: 200px;">Cadastro de Unidade</legend>
						...
						<div id="cads">
							...
							<h:commandButton value="#{msgs['Unidade.cadastro.botao']}"
								action="#{UnidadeBean.Cadastrar}" styleClass="botoes"
